...
const SkillRow = ({ label, value, icon: Icon }) => (
...
export default function Portfolio() {
  ...
  // Hero Images Array - Mix of profile and aesthetics
  const heroImages = [
    "/24.jpg",
    "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=1000&auto=format&fit=crop", // Tech Abstract
    "https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=1000&auto=format&fit=crop", // Code Screen
  ];
  ...
  // Handle "Lets Talk" Button Click (Transponder Snail) - Professional Format
  const handleSendSignal = (e) => {
    e.preventDefault();

    const subject = `Inquiry: Project Discussion with ${formName}`;

    // Using %0D%0A for line breaks in mailto
    ...
    window.location.href = `mailto:cstadav0513@gmail.com?subject=${subject}&body=${body}`;
  };
  ...
  return (
    <div className="min-h-screen bg-[#f0f0f0] text-black font-sans selection:bg-red-600 selection:text-white overflow-x-hidden cursor-none relative">
      ...
      <header className="relative pt-32 pb-0 bg-transparent border-b-2 border-black overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 mb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            ...
            {/* Right: Character/Image Area with Slideshow */}
            <div className="lg:col-span-5 relative h-[400px] md:h-[500px] lg:h-[600px] flex items-end justify-center mt-8 lg:mt-0">
              ...
              <div className="relative z-10 w-full h-full bg-white border-2 border-black overflow-hidden flex flex-col shadow-xl">
                ...
                <div className="flex-grow relative bg-gray-200 overflow-hidden group">
                  ...
                  <AnimatePresence mode="popLayout">
                    <motion.div
                      ...
                      transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }} // Apple-style spring easing
                ...
                {/* Static Footer - Does not animate */}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            <div className="md:col-span-7 font-serif text-lg md:text-xl leading-loose text-justify text-gray-800">
              ...
              <p className="mb-8">
                I focus on **Next.js** and **React**. I build websites that look
                great, load fast, and work perfectly on all devices. I treat
                every project like my own, ensuring you get the best quality
                work.
              </p>
            ...
            <div className="md:col-span-5 grid grid-cols-2 gap-4 h-min content-start">
              ...
              {/* Total Commits (Dummy Data as requested) */}
              <BentoCard
                delay={0.3}
      ...
      <footer className="bg-black text-white border-t-2 border-white/10 pt-16 pb-0 overflow-hidden relative">
        ...
        {/* Giant Footer Text Effect Marquee */}
